...
void draw_polygons( struct matrix *polygons, screen s, color c ) {
  ...
  for (point=0; point < polygons->lastcol-2; point+=3) {
    ...
    */
    ...
    else if(zbuff_valb > zbuff_initval && normal[2]>0){
      zbuff_initval = zbuff_valb;
    ...
    else if(zbuff_valc > zbuff_initval && normal[2]>0){
      zbuff_initval = zbuff_valc;
